...
var hotels_pb = require('./hotels_pb.js');

function serialize_hotels_HotelRequest(arg) {
  if (!(arg instanceof hotels_pb.HotelRequest)) {
...
function deserialize_hotels_HotelRequest(buffer_arg) {
  return hotels_pb.HotelRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_hotels_HotelResponse(arg) {
  if (!(arg instanceof hotels_pb.HotelResponse)) {
...
function deserialize_hotels_HotelResponse(buffer_arg) {
  return hotels_pb.HotelResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_hotels_HotelsRequest(arg) {
  if (!(arg instanceof hotels_pb.HotelsRequest)) {
...
function deserialize_hotels_HotelsRequest(buffer_arg) {
  return hotels_pb.HotelsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_hotels_HotelsResponse(arg) {
  if (!(arg instanceof hotels_pb.HotelsResponse)) {
...
function deserialize_hotels_HotelsResponse(buffer_arg) {
  return hotels_pb.HotelsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var HotelsService = exports.HotelsService = {
  getHotels: {
    ...
    requestType: hotels_pb.HotelsRequest,
    responseType: hotels_pb.HotelsResponse,
  ...
  getHotel: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: hotels_pb.HotelRequest,
    responseType: hotels_pb.HotelResponse,
